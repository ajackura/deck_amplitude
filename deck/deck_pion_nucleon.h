...
namespace deck_pion_nucleon
{
  ...
  ****************************************************************************/
  ...
  cd M_pp_p_mm ( double W,
		 ...
		 double phi )
  {
    //    std::cerr << " z initial " << z << std::endl;
    //    std::cerr << " W initial " << W << std::endl;
    //    std::cerr << " s initial " << s << std::endl;
    //    std::cerr << " t initial " << t << std::endl;
    //    std::cerr << " s1 initial " << s1 << std::endl;
    //    std::cerr << " phi initial " << phi << std::endl;
    ...
    //    std::cerr << "z " << z << " sine " << sinepx << " " << sin_z << std::endl;
		 ...
		 double phi )
  {
    ...
    //    std::cerr << " sinemx " << sinemx << std::endl;
    //    std::cerr << " sine_z " << sin_z << std::endl; 
    double p1     = dk::p1 ( W, s1 );
		...
		int mu_p )
  {
	...
	//	std::cerr << " A + xi * C " << A + xi * C << std::endl;
	return A + xi * C;
      }
    else if ( ( mu_p == -1 ) && ( mu == -1 ) )
      { 
                        ...
                        double t )
  {
    ...
    //    std::cout << " cos_ep " << cos_ep << " cos_xi " << cos_xi << std::endl;
